package com.example.finalcalculation;       //이 클래스는 com.example 위치에 있는 finalcalculation 안에 있습니다
...
public class MainActivity extends AppCompatActivity {
    ...
    static final String MAX="9999999999999999";
    static final String MIN="0.0000000000000001";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bRoute=findViewById(R.id.Button_route);
        ...
        bPM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // 정수인지 판별 + "." 이 불리지 않았다면
                if ((Double.parseDouble(eResult.getText().toString()) - ((int) Double.parseDouble(eResult.getText().toString()))) == 0.0 && !checkDot) {
                    eResult.setText("" + ((int)(Double.parseDouble(eResult.getText().toString())) * -1));
                } else {
                    eResult.setText("" + (Double.parseDouble(eResult.getText().toString()) * -1));
                }
            }
        });                 //정수,실수 판단 후 부호 반전
    }

    Button.OnClickListener trans= new Button.OnClickListener() {          //연산자별 동작 구현
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.Button_divideX:
                    transTYPE=DIVX;
                    if(CYCLE==0) {
                        history="1/"+eResult.getText().toString();
                ...
                case R.id.Button_power:
                    transTYPE=POWER;
                    if(CYCLE==0) {
                        history="sqr("+eResult.getText().toString()+")";
                        eShow.setText(history);
                    }
                    else{
                ...
                case R.id.Button_route:
                    transTYPE=ROUTE;
                    if(CYCLE==0) {
                        history="sqrt("+eResult.getText().toString()+")";
                        eShow.setText(history);
                    }
                    else {
    ...
    public void setText(String num){
        ...
        //num=eResult.getText().toString().replace(",","");
    }
    ...
    public void onClick(View v){        //0~9 , . 까지 button 구현
        ...
        switch (v.getId()){
            case R.id.Button_0:
                if(eResult.getText().toString().equals("0")){    // 처음 0 2번이상 눌리는거 방지
                    checkStart=true;
                }else{
            ...
            case R.id.Button_dot:
                if(checkDot){
                    ...
                    if(eResult.getText().toString().equals("")) {               //처음 . 입력시
                        Toast.makeText(this, "0.생성", Toast.LENGTH_SHORT).show();
                        eResult.setText("0.");
                    }
                    else {
